...
export const UserPage = ({ match }) => {
  ...
  //   return allPosts.filter(post => post.user === userId) Так делать нельзя, это ломает прицип работы useSelector.
  ...
  const postsForUser = useSelector((state) => selectPostByUser(state, userId, 200));
